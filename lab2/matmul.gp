...
plot \
"matmul_block_access_parallel_inner_T2.dat" t "Loop tiling - inner loop - 2 threads",\
"matmul_block_access_parallel_outer_T2.dat" t "Loop tiling - outer loop - 2 threads",\
